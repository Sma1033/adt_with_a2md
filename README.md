...
- penalty search: A demo ipynb script to demo the process of obtaining a penalty value (as similarity measurement) for a given audio pair. Please check file `penalty_search.ipynb` for more details.
